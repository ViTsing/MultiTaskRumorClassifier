...
For simplicity, we only show the parameter adjustment on RumorEval as an example. We choose the embedding dimension, batch size, and hidden units as the representative parameters. During each running, we vary one parameter and fix the other parameters to record the variation trend of \textcolor{blue}{RL-ERT}. The Fig.~\ref{fig:parameter_events} shows the results of parameter adjustment on each event. The Fig.~\ref{fig:parameter_art} records the performance of \textcolor{blue}{RL-ERT} during parameter adjustment. It suggests that when the embedding dim is 32, batch size is 64, and size of hidden units is 100, \textcolor{blue}{RL-ERT} achieves the best performance on RumorEval dataset. The smaller parameter value corresponds to the small scale of RumorEval.
...
\begin{table}[htbp]
	...
	\resizebox{1\linewidth}{!}{
		\begin{tabular}{|c|c|c|c|}
			...
			& 0.644 & 0.632 \\
			\hline
			\textcolor{blue}{ERT} without RL  & 0.979/0.951/0.943/0.926/0.944
			& 0.949 & 0.949 \\
			\hline
			\textcolor{blue}{RL-ERT}  & 0.982/0.954/\textbf{0.945}/0.923/\textbf{0.964}
			& 0.951 & \textbf{0.954} \\
			\hline					
		\end{tabular}
	}	
...
\begin{table}[htbp]
	...
	\resizebox{1\linewidth}{!}{
		\begin{tabular}{|c|c|c|c|}
			...
			& 0.934 & 0.935 \\
			\hline
			\textcolor{blue}{ERT} without RL  &0.985/0.934/0.926/0.913/0.912
			& 0.936 & 0.934 \\
			\hline
			\textcolor{blue}{RL-ERT} &\textbf{0.987}/\textbf{0.937}/\textbf{0.931}/\textbf{0.920}/\textbf{0.939}
