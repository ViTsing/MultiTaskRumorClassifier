...
\begin{itemize}
	...
	\item We analyze the rumor tracking task and find suitable features and embedding methods. Also, we propose a vote based aggregation algorithm to aggregated several basic models into a macrocosm.
