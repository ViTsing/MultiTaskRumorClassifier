...
\textcolor{blue}{We aggregate multiple components to the ART with a vote based algorithm, and then mining specific social features to further improve the performance.}
