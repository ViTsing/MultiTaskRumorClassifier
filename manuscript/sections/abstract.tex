...
RL-BRT adopts a bagging algorithm to aggregate multiple components by a weight-tuning policy network, and utilizes specific social features to improve the performance.
Finally, we conduct experiments on public datasets and the experimental results show the superiority of RL-BRT on efficiency and effectiveness.
\end{abstract}