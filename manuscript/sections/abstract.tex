...
RL-BRT adopts a bagging algorithm to aggregate multiple components by a weight-tuning policy network, and utilize specific social features to improve the performance.
