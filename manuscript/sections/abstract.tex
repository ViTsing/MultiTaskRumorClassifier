...
To this end, we propose a deep reinforcement learning based bagging model for rumor tracking, namely RL-BRT. 
We aggregate multiple components with a bagging algorithm, in which we propose a weight-tuning policy network (WTPN), and discover specific social features to improve the performance.
