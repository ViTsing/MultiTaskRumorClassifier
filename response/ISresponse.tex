...
\begin{document}
	...
	\begin{response}
		Thanks for the suggestions. We have revised the manuscript and have added the analysis of components in Section 4.3.
	\end{response}
	...
	\begin{response}
		Thanks for the suggestions. We have revised the manuscript as suggested in Section 2.2.
	\end{response}
	...
	\begin{response}
		Thanks for the suggestions. We have added more detailed descriptions of DPG and Weight-Tuning Policy Network in Section 3.4.
	\end{response}
	...
	\begin{response}
		Thanks for the suggestions. We have revised the manuscript as suggested and have added the component analysis in Section 4.3.
	\end{response}
	...
	\begin{response}
		Thanks for pointing out this. We have revised the manuscript and have added the motivations in Section 2.3. 
	\end{response}
	...
	\begin{response}
		Thanks for pointing out this. We have revised Fig.4 as suggested by including the multiplication operation of the predicted matrix $K_y$ and $W_y$. 
	\end{response}
	...
	\begin{response}
		Thanks for pointing out this. We have revised the manuscript as suggested and have added the detailed motivation of the reinforcement learning at Line 120 $\sim$ Line 125. 
	\end{response}
	...
	\begin{response}
		\begin{itemize}
			\item Line 1: Thanks for the suggestions at Line 1, Line 11, Line 17, Line 33, and Line 63. We have revised the manuscript as suggested. 
			
			\item Line 37: Thanks for the suggestions. We intend to use a word to refer to the state of being one complete whole or condition of being united. However, `macrocosm' is not proper, and we have replaced it with `unity'.
			
			\item Line 79: Thanks for the suggestions. We have revised the manuscript and have replaced `concat()' with $[\cdot]$ by following existing papers.
			...
			\item Line 115: Thanks for the suggestions. We have revised the manuscript as suggested in Fig.3. Besides, we have revised other use of formalization.
		\end{itemize}
	\end{response}
